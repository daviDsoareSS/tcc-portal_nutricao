    ...
    <form action="acesso.php" class="container-criar-conta" method="post" id="form">
            ...
            <div class="modal-content">
                    <div class="modal-body">
                        <!-- início do preloader -->
                            ...
                            <div class="bolas-create-account">
                                <p>Aguarde...</p>
                                <div></div>
                                <div></div>
                                <div></div>                    
       ...
       <?php 
        ...
        <p><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24"><path d="M20.822 18.096c-3.439-.794-6.64-1.49-5.09-4.418 4.72-8.912 1.251-13.678-3.732-13.678-5.082 0-8.464 4.949-3.732 13.678 1.597 2.945-1.725 3.641-5.09 4.418-3.073.71-3.188 2.236-3.178 4.904l.004 1h23.99l.004-.969c.012-2.688-.092-4.222-3.176-4.935z"/></svg> Digite seu nome:</p>
            <input type="text" name="nome" id="nomeUser" placeholder="Digite nome e sobrenome">
        <p><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24"><path d="M20 20h-4v-4h4v4zm-6-10h-4v4h4v-4zm6 0h-4v4h4v-4zm-12 6h-4v4h4v-4zm6 0h-4v4h4v-4zm-6-6h-4v4h4v-4zm16-8v22h-24v-22h3v1c0 1.103.897 2 2 2s2-.897 2-2v-1h10v1c0 1.103.897 2 2 2s2-.897 2-2v-1h3zm-2 6h-20v14h20v-14zm-2-7c0-.552-.447-1-1-1s-1 .448-1 1v2c0 .552.447 1 1 1s1-.448 1-1v-2zm-14 2c0 .552-.447 1-1 1s-1-.448-1-1v-2c0-.552.447-1 1-1s1 .448 1 1v2z"/></svg> Digite sua data de nascimento:</p>
            <input type="date" name="dataNasc" id="dataNasc" placeholder="*somente números">
        <p><svg width="24" height="24" xmlns="http://www.w3.org/2000/svg" fill-rule="evenodd" clip-rule="evenodd"><path d="M0 1h24v22h-24v-22zm22 20v-15h-20v15h20zm-5.455-10.48l-4.143 3.579c-.675-.138-1.401.068-1.894.618-.735.824-.665 2.088.159 2.824.823.736 2.088.665 2.824-.158.492-.551.616-1.296.402-1.951l3.107-4.507-.455-.405zm-9.545 6.48h-3c0-4.415 3.585-8 8-8 1.163 0 2.269.249 3.267.696l-2.79 2.326-.477-.022c-2.759 0-5 2.24-5 5zm13 0h-3c0-.864-.219-1.676-.605-2.385l1.729-2.761c1.17 1.392 1.876 3.187 1.876 5.146z"/></svg> Digite seu peso inicial:</p>
            <input type="text" name="pesoIni" id="pesoIni" placeholder="ex. 68.7">
        <p><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24"><path d="M18.342 0l-2.469 2.47 2.121 2.121-.707.707-2.121-2.121-1.414 1.414 1.414 1.414-.707.707-1.414-1.414-1.414 1.414 1.414 1.414-.707.707-1.414-1.414-1.414 1.414 2.121 2.122-.707.707-2.121-2.121-1.414 1.414 1.414 1.414-.708.707-1.414-1.414-1.414 1.414 1.414 1.414-.708.709-1.414-1.414-1.414 1.413 2.121 2.121-.706.706-2.122-2.121-2.438 2.439 5.656 5.657 18.344-18.343z"/></svg> Digite sua altura:</p>
            <input type="text" name="altura" id="altura" placeholder="ex. 1.75">
        <div class="container-sexo-user">
            <p>Sexo:</p>
            <small>Masculino</small>
            <input type="radio" class="sexoUser" name="sexoUser" id="Masculino" value="masculino" checked>
            <small>Feminino</small>
            <input type="radio" class="sexoUser" name="sexoUser" id="Feminino" value="feminino">
       </div>
       </div>
        <div class="container-email">
            ...
            <button class="btn btn-primary" id="submit" type="submit" data-bs-toggle="modal" data-bs-target="#JanelaModal">CRIAR CONTA</button>
    </div>
